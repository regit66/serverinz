...
public class Connection extends Thread {
    ...
    public Connection(Socket aClientSocket, List<Client> clientList, GuiApp gui, Client cc) {
        ...
        try {
            ...
            System.out.println("connection.Connection:" + e.getMessage());
    ...
    private void readFromClient(Client cc) {
        ...
        try {
            ...
            System.out.println("connection.client.Client " + clientSocket.getInetAddress().getHostName() + " : " + clientSocket.getPort() + ": " + redDataText);
        ...
        // System.out.println("odczytano, Data From connection.client.Client: " + clientData.toString());
    ...
    private void disconnect() {
        System.out.println("connection.client.Client " + clientSocket.getInetAddress().getHostName() + " : " + clientSocket.getPort() + " disconnect");
        removeClient();
        stop();

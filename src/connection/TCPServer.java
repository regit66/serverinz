package connection;// connection.TCPServer.java
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println("connection.Connection received from " + clientSocket.getInetAddress().getHostName() + " : " + clientSocket.getPort());
